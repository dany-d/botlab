...
, map_(10.0f, 10.0f, 0.05f) //30,30,0.1  // create a 10m x 10m grid with 0.05m cells; changed from 0.025
...
void OccupancyGridSLAM::runSLAMIteration(void)
{
    ...
    {
        updateLocalization();
        //std::cout<<fabs(previousPose_.theta - currentPose_.theta)<<std::endl;
        //if(fabs(previousPose_.theta - currentPose_.theta)<0.15){
          updateMap();
        //}
        //else{
        //  std::cout<<"Turning, map not updated.\n";
        //}
