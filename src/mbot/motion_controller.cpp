...
// float clamp_angular(float speed)
// {
//     if(speed < -1.5f)
//     {
//         return -1.5f;
...
//             if(state_ == TURN)
//             {
//                 if(std::abs(error) > 0.10) // turn in place until pointed approximately at the target
//                 {
...
//                 if (distToGoal < slowDownDistance and targets_.size() == 1) {
//                     speed= kDesiredSpeed*distToGoal/slowDownDistance + 0.08;
//                     // speed = kMinSpeed * (distToGoal - slowDownDistance) + kDesiredSpeed;
//                 }
...
//     bool haveReachedTarget(void)
//     {
//         const float kPosTolerance = 0.15f;
//         const float kFinalPosTolerance = 0.05f;
...
//         if(controller.timesync_initialized()){
//                 mbot_motor_command_t cmd = controller.updateCommand();
//                 cmd.trans_v = clamp_speed(cmd.trans_v);
//                 cmd.angular_v = clamp_angular(cmd.angular_v);
